...
from .ai2v_datasets import AI2V_dataset
...
def getdataset(args):
    ...
    if args.dataset == 't2v':
        ...
        tokenizer = AutoTokenizer.from_pretrained(args.text_encoder_name, cache_dir=args.cache_dir)
        return AI2V_dataset(args, transform=transform, temporal_sample=temporal_sample, tokenizer=tokenizer)
