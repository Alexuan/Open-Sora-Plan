...
def main(args):
    ...
    ae = getae_wrapper(args.ae)(args.ae_model_config, args.ae_ckpt).eval()
    if args.enable_tiling:
        ae.vae.enable_tiling()
        ae.vae.tile_overlap_factor = args.tile_overlap_factor
    # NOTE (Xuan): comment text
    ...
    if args.pretrained:
        if 'safetensors' in args.pretrained:
            ...
            # checkpoint = torch.load(args.pretrained, map_location='cpu')['model']  # t2v.pt
             checkpoint = torch.load(args.pretrained, map_location='cpu')['ema']  # t2v_v20240523.pt
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ae_model_config", type=str, default="")
